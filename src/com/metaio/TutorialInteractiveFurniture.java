...
public class TutorialInteractiveFurniture extends ARViewActivity
{
	...
	protected void loadContents()
	{
		try
		{
			...
			String filepath =
					AssetsManager.getAssetPath(getApplicationContext(), "TutorialInteractiveFurniture/Assets/tv.obj");
			if (filepath != null)
			{
			...
			if (filepath != null)
			{
				...
				if (mScreen != null)
				{
					...
					mScreen.setMovieTexture(AssetsManager.getAssetPath(getApplicationContext(),
			...
			filepath =
					AssetsManager
							.getAssetPath(getApplicationContext(), "TutorialInteractiveFurniture/Assets/stuhl.obj");
			if (filepath != null)
			{
			...
			runOnUiThread(new Runnable()
			{
				...
				public void run()
				{
					...
					else
					{
						...
						MediaScannerConnection.scanFile(getApplicationContext(), new String[] {realPath},
								new String[] {"image/jpg"}, new OnScanCompletedListener()
								{
									@Override
