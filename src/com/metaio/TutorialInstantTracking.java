...
public class TutorialInstantTracking extends ARViewActivity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		try
		{
			...
			FileInputStream fis =
					new FileInputStream(AssetsManager.getAssetPath(getApplicationContext(),
	...
	protected void loadContents()
	{
		...
		{
			// Load tiger model
			String tigerModelPath =
					AssetsManager.getAssetPath(getApplicationContext(), "TutorialInstantTracking/Assets/tiger.md2");
