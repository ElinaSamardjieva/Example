...
public class TutorialFaceTracking extends ARViewActivity 
{
	...
	protected void loadContents() 
	{
		try
		{
			...
			String filepath = AssetsManager.getAssetPath(getApplicationContext(), "TutorialFaceTracking/Assets/Thought1.png");			
			if (filepath != null) 
			{
			...
			// Getting file path for the image
			filepath = AssetsManager.getAssetPath(getApplicationContext(), "TutorialFaceTracking/Assets/Thought2.png");			
			if (filepath != null) 
			{
				// Create geometry from image file
				IGeometry geometry = metaioSDK.createGeometryFromImage(filepath);
