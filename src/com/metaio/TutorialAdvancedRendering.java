...
public class TutorialAdvancedRendering extends ARViewActivity
{
	...
	protected void loadContents()
	{
		try
		{
			...
			final String trackingConfigFile = AssetsManager.getAssetPath(getApplicationContext(), "TutorialAdvancedRendering/Assets/TrackingData_MarkerlessFast.xml");
			...
			// loading geometry
			final String filepath = AssetsManager.getAssetPath(getApplicationContext(), "TutorialAdvancedRendering/Assets/metaioman.md2");
			if (filepath != null) 
			{
